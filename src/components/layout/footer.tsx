...
import { SOCIAL_LINKS, SUPPORT_EMAIL } from '@/config/constants'

const footerLinks = {
  platform: [
    { label: 'Découvrir', href: '/search' },
    { label: 'Destinations', href: '/destinations' },
    { label: 'Comment ça marche', href: '/how-it-works' },
    { label: 'Proposer une expérience', href: '/register?role=provider' },
  ],
  support: [
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs">
              Découvrez les expériences authentiques du Sahara tunisien avec des guides locaux vérifiés.
            </p>
          ...
          {Object.entries(footerLinks).map(([key, links]) => (
            <div key={key}>
              <h3 className="text-sm font-semibold text-foreground capitalize mb-3">
                {key === 'platform' ? 'Plateforme' : key === 'support' ? 'Support' : 'Légal'}
              </h3>
